...
public class EventsAdapterFactory extends AdapterFactoryImpl {
  ...
  protected EventsSwitch<Adapter> modelSwitch =
    new EventsSwitch<Adapter>() {
      ...
      @Override
      public Adapter caseEventInfo(EventInfo object) {
        return createEventInfoAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link goedegep.events.model.Events <em>Events</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link goedegep.events.model.EventInfo <em>Event Info</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createEventInfoAdapter() {
    return null;
  }

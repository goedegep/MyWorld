/**
 */
package goedegep.events.model.util;
...
public class EventsSwitch<T> extends Switch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      case EventsPackage.EVENTS: {
        Events events = (Events)theEObject;
        T result = caseEvents(events);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EventsPackage.EVENT_INFO: {
        EventInfo eventInfo = (EventInfo)theEObject;
        T result = caseEventInfo(eventInfo);
        if (result == null) result = caseEvent(eventInfo);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Event Info</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Event Info</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseEventInfo(EventInfo object) {
    return null;
  }

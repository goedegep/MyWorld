...
public interface InvAndPropPackage extends EPackage {
   ...
   * @ordered
   */
  int INVOICES_AND_PROPERTIES__INVOICSEANDPROPERTYS = 2;
   ...
   * @ordered
   */
  int INVOICES_AND_PROPERTIES_FEATURE_COUNT = 3;
   ...
   * @generated
   */
  int INVOICE_AND_PROPERTY_ITEM = 7;

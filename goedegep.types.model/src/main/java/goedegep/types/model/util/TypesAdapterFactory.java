...
public class TypesAdapterFactory extends AdapterFactoryImpl {
  ...
  protected TypesSwitch<Adapter> modelSwitch = new TypesSwitch<Adapter>() {
    ...
    @Override
    public Adapter caseDateRateTuplet(DateRateTuplet object) {
      return createDateRateTupletAdapter();
    }
  ...
  /**
   * Creates a new adapter for an object of class '{@link goedegep.types.model.FileReference <em>File Reference</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link goedegep.types.model.DateRateTuplet <em>Date Rate Tuplet</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createDateRateTupletAdapter() {
    return null;
  }

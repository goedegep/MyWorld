...
import goedegep.gpx10.model.util.GPX10Validator;
 ...
 * @generated
 */
public class GPX10PackageImpl extends EPackageImpl implements GPX10Package {
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   ...
   * @see goedegep.gpx10.model.GPX10Package#eNS_URI
   * @see #init()
   * @generated
   */
  private GPX10PackageImpl() {
    super(eNS_URI, GPX10Factory.eINSTANCE);
  }
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   *
   * <p>This method is used to initialize {@link GPX10Package#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static GPX10Package init() {
    if (isInited) return (GPX10Package)EPackage.Registry.INSTANCE.getEPackage(GPX10Package.eNS_URI);

    // Obtain or create and register package
    Object registeredGPX10Package = EPackage.Registry.INSTANCE.get(eNS_URI);
    GPX10PackageImpl theGPX10Package = registeredGPX10Package instanceof GPX10PackageImpl ? (GPX10PackageImpl)registeredGPX10Package : new GPX10PackageImpl();
    ...
    theGPX10Package.createPackageContents();

    // Initialize created meta-data
    theGPX10Package.initializePackageContents();
      ...
      (theGPX10Package,
       new EValidator.Descriptor() {
         public EValidator getEValidator() {
           return GPX10Validator.INSTANCE;
         }
       });

    // Mark meta-data to indicate it can't be changed
    theGPX10Package.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(GPX10Package.eNS_URI, theGPX10Package);
    return theGPX10Package;
  }
   ...
   * @generated
   */
  public GPX10Factory getGPX10Factory() {
    return (GPX10Factory)getEFactoryInstance();
  }

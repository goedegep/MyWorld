...
import goedegep.gpx10.model.WptType;
 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getEle <em>Ele</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getTime <em>Time</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getMagvar <em>Magvar</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getGeoidheight <em>Geoidheight</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getCmt <em>Cmt</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getSrc <em>Src</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getUrlname <em>Urlname</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getSym <em>Sym</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getFix <em>Fix</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getSat <em>Sat</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getHdop <em>Hdop</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getVdop <em>Vdop</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getPdop <em>Pdop</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getAgeofdgpsdata <em>Ageofdgpsdata</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getDgpsid <em>Dgpsid</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getLat <em>Lat</em>}</li>
 *   <li>{@link goedegep.gpx10.model.impl.WptTypeImpl#getLon <em>Lon</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WptTypeImpl extends MinimalEObjectImpl.Container implements WptType {
  ...
  protected EClass eStaticClass() {
    return GPX10Package.Literals.WPT_TYPE;
  }
  ...
  public void setEle(BigDecimal newEle) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__ELE, oldEle, ele));
  }
  ...
  public void setTime(XMLGregorianCalendar newTime) {
    ...
    time = newTime;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__TIME, oldTime, time));
  }
  ...
  public void setMagvar(BigDecimal newMagvar) {
    ...
    magvar = newMagvar;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__MAGVAR, oldMagvar, magvar));
  }
  ...
  public void setGeoidheight(BigDecimal newGeoidheight) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__GEOIDHEIGHT, oldGeoidheight, geoidheight));
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__NAME, oldName, name));
  }
  ...
  public void setCmt(String newCmt) {
    ...
    cmt = newCmt;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__CMT, oldCmt, cmt));
  }
  ...
  public void setDesc(String newDesc) {
    ...
    desc = newDesc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__DESC, oldDesc, desc));
  }
  ...
  public void setSrc(String newSrc) {
    ...
    src = newSrc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__SRC, oldSrc, src));
  }
  ...
  public void setUrl(String newUrl) {
    ...
    url = newUrl;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__URL, oldUrl, url));
  }
  ...
  public void setUrlname(String newUrlname) {
    ...
    urlname = newUrlname;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__URLNAME, oldUrlname, urlname));
  }
  ...
  public void setSym(String newSym) {
    ...
    sym = newSym;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__SYM, oldSym, sym));
  }
  ...
  public void setType(String newType) {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__TYPE, oldType, type));
  }
  ...
  public void setFix(FixType newFix) {
    ...
    fixESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__FIX, oldFix, fix, !oldFixESet));
  }
  ...
  public void unsetFix() {
    ...
    fixESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, GPX10Package.WPT_TYPE__FIX, oldFix, FIX_EDEFAULT, oldFixESet));
  }
  ...
  public void setSat(BigInteger newSat) {
    ...
    sat = newSat;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__SAT, oldSat, sat));
  }
  ...
  public void setHdop(BigDecimal newHdop) {
    ...
    hdop = newHdop;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__HDOP, oldHdop, hdop));
  }
  ...
  public void setVdop(BigDecimal newVdop) {
    ...
    vdop = newVdop;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__VDOP, oldVdop, vdop));
  }
  ...
  public void setPdop(BigDecimal newPdop) {
    ...
    pdop = newPdop;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__PDOP, oldPdop, pdop));
  }
  ...
  public void setAgeofdgpsdata(BigDecimal newAgeofdgpsdata) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__AGEOFDGPSDATA, oldAgeofdgpsdata, ageofdgpsdata));
  }
  ...
  public void setDgpsid(BigInteger newDgpsid) {
    ...
    dgpsid = newDgpsid;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__DGPSID, oldDgpsid, dgpsid));
  }
  ...
  public FeatureMap getAny() {
    if (any == null) {
      any = new BasicFeatureMap(this, GPX10Package.WPT_TYPE__ANY);
    }
    return any;
  }
  ...
  public void setLat(BigDecimal newLat) {
    ...
    lat = newLat;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__LAT, oldLat, lat));
  }
  ...
  public void setLon(BigDecimal newLon) {
    ...
    lon = newLon;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GPX10Package.WPT_TYPE__LON, oldLon, lon));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case GPX10Package.WPT_TYPE__ANY:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case GPX10Package.WPT_TYPE__ELE:
        return getEle();
      case GPX10Package.WPT_TYPE__TIME:
        return getTime();
      case GPX10Package.WPT_TYPE__MAGVAR:
        return getMagvar();
      case GPX10Package.WPT_TYPE__GEOIDHEIGHT:
        return getGeoidheight();
      case GPX10Package.WPT_TYPE__NAME:
        return getName();
      case GPX10Package.WPT_TYPE__CMT:
        return getCmt();
      case GPX10Package.WPT_TYPE__DESC:
        return getDesc();
      case GPX10Package.WPT_TYPE__SRC:
        return getSrc();
      case GPX10Package.WPT_TYPE__URL:
        return getUrl();
      case GPX10Package.WPT_TYPE__URLNAME:
        return getUrlname();
      case GPX10Package.WPT_TYPE__SYM:
        return getSym();
      case GPX10Package.WPT_TYPE__TYPE:
        return getType();
      case GPX10Package.WPT_TYPE__FIX:
        return getFix();
      case GPX10Package.WPT_TYPE__SAT:
        return getSat();
      case GPX10Package.WPT_TYPE__HDOP:
        return getHdop();
      case GPX10Package.WPT_TYPE__VDOP:
        return getVdop();
      case GPX10Package.WPT_TYPE__PDOP:
        return getPdop();
      case GPX10Package.WPT_TYPE__AGEOFDGPSDATA:
        return getAgeofdgpsdata();
      case GPX10Package.WPT_TYPE__DGPSID:
        return getDgpsid();
      case GPX10Package.WPT_TYPE__ANY:
        if (coreType) return getAny();
        return ((FeatureMap.Internal)getAny()).getWrapper();
      case GPX10Package.WPT_TYPE__LAT:
        return getLat();
      case GPX10Package.WPT_TYPE__LON:
        return getLon();
    }

 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.gpx10.model.impl.TrksegTypeImpl#getTrkpt <em>Trkpt</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TrksegTypeImpl extends MinimalEObjectImpl.Container implements TrksegType {
  ...
  protected EClass eStaticClass() {
    return GPX10Package.Literals.TRKSEG_TYPE;
  }
  ...
  public EList<TrkptType> getTrkpt() {
    if (trkpt == null) {
      trkpt = new EObjectContainmentEList<TrkptType>(TrkptType.class, this, GPX10Package.TRKSEG_TYPE__TRKPT);
    }
    return trkpt;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case GPX10Package.TRKSEG_TYPE__TRKPT:

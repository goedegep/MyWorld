 ...
 * @generated
 */
public class GPX10Validator extends EObjectValidator {
  /**
   ...
   * @generated
   */
  public static final GPX10Validator INSTANCE = new GPX10Validator();
   ...
   * @generated
   */
  public static final String DIAGNOSTIC_SOURCE = "goedegep.gpx10.model";
  ...
  public boolean validateDegreesType_Min(BigDecimal degreesType, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (!result && diagnostics != null)
      reportMinViolation(GPX10Package.Literals.DEGREES_TYPE, degreesType, DEGREES_TYPE__MIN__VALUE, true, diagnostics, context);
    return result;
  }
  ...
  public boolean validateDegreesType_Max(BigDecimal degreesType, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (!result && diagnostics != null)
      reportMaxViolation(GPX10Package.Literals.DEGREES_TYPE, degreesType, DEGREES_TYPE__MAX__VALUE, true, diagnostics, context);
    return result;
  }
  ...
  public boolean validateDgpsStationType_Min(BigInteger dgpsStationType, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (!result && diagnostics != null)
      reportMinViolation(GPX10Package.Literals.DGPS_STATION_TYPE, dgpsStationType, DGPS_STATION_TYPE__MIN__VALUE, true, diagnostics, context);
    return result;
  }
  ...
  public boolean validateDgpsStationType_Max(BigInteger dgpsStationType, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (!result && diagnostics != null)
      reportMaxViolation(GPX10Package.Literals.DGPS_STATION_TYPE, dgpsStationType, DGPS_STATION_TYPE__MAX__VALUE, true, diagnostics, context);
    return result;
  }
  ...
  public boolean validateEmailType_Pattern(String emailType, DiagnosticChain diagnostics, Map<Object, Object> context) {
    return validatePattern(GPX10Package.Literals.EMAIL_TYPE, emailType, EMAIL_TYPE__PATTERN__VALUES, diagnostics, context);
  }
  ...
  public boolean validateLatitudeType_Min(BigDecimal latitudeType, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (!result && diagnostics != null)
      reportMinViolation(GPX10Package.Literals.LATITUDE_TYPE, latitudeType, LATITUDE_TYPE__MIN__VALUE, true, diagnostics, context);
    return result;
  }
  ...
  public boolean validateLatitudeType_Max(BigDecimal latitudeType, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (!result && diagnostics != null)
      reportMaxViolation(GPX10Package.Literals.LATITUDE_TYPE, latitudeType, LATITUDE_TYPE__MAX__VALUE, true, diagnostics, context);
    return result;
  }
  ...
  public boolean validateLongitudeType_Min(BigDecimal longitudeType, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (!result && diagnostics != null)
      reportMinViolation(GPX10Package.Literals.LONGITUDE_TYPE, longitudeType, LONGITUDE_TYPE__MIN__VALUE, true, diagnostics, context);
    return result;
  }
  ...
  public boolean validateLongitudeType_Max(BigDecimal longitudeType, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (!result && diagnostics != null)
      reportMaxViolation(GPX10Package.Literals.LONGITUDE_TYPE, longitudeType, LONGITUDE_TYPE__MAX__VALUE, true, diagnostics, context);
    return result;
  }

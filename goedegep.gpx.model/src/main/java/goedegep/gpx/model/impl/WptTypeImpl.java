 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getEle <em>Ele</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getTime <em>Time</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getMagvar <em>Magvar</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getGeoidheight <em>Geoidheight</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getCmt <em>Cmt</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getSrc <em>Src</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getLink <em>Link</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getSym <em>Sym</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getFix <em>Fix</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getSat <em>Sat</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getHdop <em>Hdop</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getVdop <em>Vdop</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getPdop <em>Pdop</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getAgeofdgpsdata <em>Ageofdgpsdata</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getDgpsid <em>Dgpsid</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getExtensions <em>Extensions</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getLat <em>Lat</em>}</li>
 *   <li>{@link goedegep.gpx.model.impl.WptTypeImpl#getLon <em>Lon</em>}</li>
 * </ul>
 *
 * @generated
 */

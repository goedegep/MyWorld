 ...
 * @generated
 */
public class EmfSampleSwitch<T> extends Switch<T> {
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      case EmfSamplePackage.PERSON: {
        Person person = (Person)theEObject;
        T result = casePerson(person);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EmfSamplePackage.BIRTHDAY: {
        Birthday birthday = (Birthday)theEObject;
        T result = caseBirthday(birthday);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EmfSamplePackage.COMPANY: {

...
public class MapTileImageView extends MapTileImageViewAbstract {
  private static final Logger LOGGER = Logger.getLogger(MapTileImageView.class.getName() );
   ...
   */
  protected final List<MapTileImageViewAbstract> coveredTiles = new LinkedList<>();
   ...
   */
  MapTileImageView(BaseMapAbstract<?> baseMapAbstract, int myZoom, long i, long j) {
...
//          setNeedsLayout(true);
   ...
   * @param child
   */
  public void addCovering(MapTileImageView child) {
...
//    child.progress.addListener(il);
  ...
  private InvalidationListener createProgressListener(MapTileImageView child) {

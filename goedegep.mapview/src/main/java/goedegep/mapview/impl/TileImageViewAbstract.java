...
public class TileImageViewAbstract extends ImageView {
  private static final Logger LOGGER = Logger.getLogger(TileImageViewAbstract.class.getName());
   ...
   */
  public TileImageViewAbstract(BaseMapAbstract<?> baseMapAbstract, int tileZoom, long i, long j) {

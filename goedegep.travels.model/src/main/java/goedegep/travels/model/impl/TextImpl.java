 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.travels.model.impl.TextImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextImpl extends VacationElementImpl implements Text {
  ...
  protected EClass eStaticClass() {
    return TravelsPackage.Literals.TEXT;
  }
  ...
  public void setText(String newText) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TravelsPackage.TEXT__TEXT, oldText, text, !oldTextESet));
  }
  ...
  public void unsetText() {
    ...
    textESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, TravelsPackage.TEXT__TEXT, oldText, TEXT_EDEFAULT,
          oldTextESet));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
    case TravelsPackage.TEXT__TEXT:
      return getText();
    }

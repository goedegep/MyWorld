 ...
 * @generated
 */
public class TravelsPackageImpl extends EPackageImpl implements TravelsPackage {
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   ...
   * @see goedegep.travels.model.TravelsPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private TravelsPackageImpl() {
    super(eNS_URI, TravelsFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link TravelsPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static TravelsPackage init() {
    if (isInited)
      return (TravelsPackage) EPackage.Registry.INSTANCE.getEPackage(TravelsPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredTravelsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    TravelsPackageImpl theTravelsPackage = registeredTravelsPackage instanceof TravelsPackageImpl
        ? (TravelsPackageImpl) registeredTravelsPackage
        : new TravelsPackageImpl();
    ...
    theTravelsPackage.createPackageContents();

    // Initialize created meta-data
    theTravelsPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theTravelsPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(TravelsPackage.eNS_URI, theTravelsPackage);
    return theTravelsPackage;
  }
   ...
   */
  @Override
  public TravelsFactory getTravelsFactory() {
    return (TravelsFactory) getEFactoryInstance();
  }

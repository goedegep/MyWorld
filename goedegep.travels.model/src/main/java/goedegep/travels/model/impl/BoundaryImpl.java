 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.travels.model.impl.BoundaryImpl#getPoints <em>Points</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoundaryImpl extends MinimalEObjectImpl.Container implements Boundary {
  ...
  protected EClass eStaticClass() {
    return TravelsPackage.Literals.BOUNDARY;
  }
  ...
  public EList<WGS84Coordinates> getPoints() {
    if (points == null) {
      points = new EDataTypeUniqueEList<WGS84Coordinates>(WGS84Coordinates.class, this,
          TravelsPackage.BOUNDARY__POINTS);
    }
    return points;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
    case TravelsPackage.BOUNDARY__POINTS:
      return getPoints();
    }

 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.travels.model.impl.DayImpl#getDays <em>Days</em>}</li>
 *   <li>{@link goedegep.travels.model.impl.DayImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DayImpl extends VacationElementImpl implements Day {
  ...
  protected EClass eStaticClass() {
    return TravelsPackage.Literals.DAY;
  }
  ...
  public void setDays(Integer newDays) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TravelsPackage.DAY__DAYS, oldDays, days, !oldDaysESet));
  }
  ...
  public void unsetDays() {
    ...
    daysESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, TravelsPackage.DAY__DAYS, oldDays, DAYS_EDEFAULT,
          oldDaysESet));
  }
  ...
  public void setTitle(String newTitle) {
    ...
    titleESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TravelsPackage.DAY__TITLE, oldTitle, title, !oldTitleESet));
  }
  ...
  public void unsetTitle() {
    ...
    titleESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, TravelsPackage.DAY__TITLE, oldTitle, TITLE_EDEFAULT,
          oldTitleESet));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
    case TravelsPackage.DAY__DAYS:
      return getDays();
    case TravelsPackage.DAY__TITLE:
      return getTitle();
    }
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    switch (operationID) {
    case TravelsPackage.DAY___GET_DATE:
      return getDate();
    }

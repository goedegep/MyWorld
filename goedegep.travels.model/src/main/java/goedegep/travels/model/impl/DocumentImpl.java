 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.travels.model.impl.DocumentImpl#getDocumentReference <em>Document Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentImpl extends VacationElementImpl implements Document {
  ...
  protected EClass eStaticClass() {
    return TravelsPackage.Literals.DOCUMENT;
  }
  ...
  public NotificationChain basicSetDocumentReference(FileReference newDocumentReference, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          TravelsPackage.DOCUMENT__DOCUMENT_REFERENCE, oldDocumentReference, newDocumentReference,
    ...
    if (newDocumentReference != documentReference) {
      ...
      if (documentReference != null)
        msgs = ((InternalEObject) documentReference).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - TravelsPackage.DOCUMENT__DOCUMENT_REFERENCE, null, msgs);
      ...
      documentReferenceESet = true;
      if (eNotificationRequired())
        eNotify(new ENotificationImpl(this, Notification.SET, TravelsPackage.DOCUMENT__DOCUMENT_REFERENCE,
  ...
  public NotificationChain basicUnsetDocumentReference(NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET,
          TravelsPackage.DOCUMENT__DOCUMENT_REFERENCE, oldDocumentReference, null, oldDocumentReferenceESet);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void unsetDocumentReference() {
    if (documentReference != null) {
      ...
      documentReferenceESet = false;
      if (eNotificationRequired())
        eNotify(new ENotificationImpl(this, Notification.UNSET, TravelsPackage.DOCUMENT__DOCUMENT_REFERENCE, null, null,
            oldDocumentReferenceESet));
    }
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
    case TravelsPackage.DOCUMENT__DOCUMENT_REFERENCE:

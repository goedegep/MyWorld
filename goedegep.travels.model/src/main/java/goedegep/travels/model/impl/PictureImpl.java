 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.travels.model.impl.PictureImpl#getPictureReference <em>Picture Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PictureImpl extends VacationElementImpl implements Picture {
  ...
  protected EClass eStaticClass() {
    return TravelsPackage.Literals.PICTURE;
  }
  ...
  public NotificationChain basicSetPictureReference(FileReference newPictureReference, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          TravelsPackage.PICTURE__PICTURE_REFERENCE, oldPictureReference, newPictureReference,
    ...
    if (newPictureReference != pictureReference) {
      ...
      if (pictureReference != null)
        msgs = ((InternalEObject) pictureReference).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - TravelsPackage.PICTURE__PICTURE_REFERENCE, null, msgs);
      ...
      pictureReferenceESet = true;
      if (eNotificationRequired())
        eNotify(new ENotificationImpl(this, Notification.SET, TravelsPackage.PICTURE__PICTURE_REFERENCE,
  ...
  public NotificationChain basicUnsetPictureReference(NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET,
          TravelsPackage.PICTURE__PICTURE_REFERENCE, oldPictureReference, null, oldPictureReferenceESet);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void unsetPictureReference() {
    if (pictureReference != null) {
      ...
      pictureReferenceESet = false;
      if (eNotificationRequired())
        eNotify(new ENotificationImpl(this, Notification.UNSET, TravelsPackage.PICTURE__PICTURE_REFERENCE, null, null,
            oldPictureReferenceESet));
    }
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
    case TravelsPackage.PICTURE__PICTURE_REFERENCE:

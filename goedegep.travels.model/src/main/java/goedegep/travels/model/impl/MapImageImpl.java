 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.travels.model.impl.MapImageImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link goedegep.travels.model.impl.MapImageImpl#getImageWidth <em>Image Width</em>}</li>
 *   <li>{@link goedegep.travels.model.impl.MapImageImpl#getImageHeight <em>Image Height</em>}</li>
 *   <li>{@link goedegep.travels.model.impl.MapImageImpl#getZoom <em>Zoom</em>}</li>
...
public class MapImageImpl extends VacationElementImpl implements MapImage {
  ...
  protected EClass eStaticClass() {
    return TravelsPackage.Literals.MAP_IMAGE;
  }
  ...
  public void setTitle(String newTitle) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TravelsPackage.MAP_IMAGE__TITLE, oldTitle, title,
          !oldTitleESet));
  }
  ...
  public void unsetTitle() {
    ...
    titleESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, TravelsPackage.MAP_IMAGE__TITLE, oldTitle, TITLE_EDEFAULT,
          oldTitleESet));
  }
  ...
  public void setImageWidth(Double newImageWidth) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TravelsPackage.MAP_IMAGE__IMAGE_WIDTH, oldImageWidth,
          imageWidth));
  }
  ...
  public void setImageHeight(Double newImageHeight) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TravelsPackage.MAP_IMAGE__IMAGE_HEIGHT, oldImageHeight,
          imageHeight));
  }
  ...
  public void setZoom(Double newZoom) {
    ...
    zoom = newZoom;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TravelsPackage.MAP_IMAGE__ZOOM, oldZoom, zoom));
  }
  ...
  public void setCenterLatitude(Double newCenterLatitude) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TravelsPackage.MAP_IMAGE__CENTER_LATITUDE,
  ...
  public void setCenterLongitude(Double newCenterLongitude) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TravelsPackage.MAP_IMAGE__CENTER_LONGITUDE,
  ...
  public void setFileName(String newFileName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, TravelsPackage.MAP_IMAGE__FILE_NAME, oldFileName, fileName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    ...
    case TravelsPackage.MAP_IMAGE__TITLE:
      return getTitle();
    case TravelsPackage.MAP_IMAGE__IMAGE_WIDTH:
      return getImageWidth();
    case TravelsPackage.MAP_IMAGE__IMAGE_HEIGHT:
      return getImageHeight();
    case TravelsPackage.MAP_IMAGE__ZOOM:
      return getZoom();
    case TravelsPackage.MAP_IMAGE__CENTER_LATITUDE:
      return getCenterLatitude();
    case TravelsPackage.MAP_IMAGE__CENTER_LONGITUDE:

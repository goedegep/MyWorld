 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.travels.model.GPXTrack#getTrackReference <em>Track Reference</em>}</li>
 * </ul>
 *
 * @see goedegep.travels.model.TravelsPackage#getGPXTrack()
 * @model
 * @generated
 */
public interface GPXTrack extends VacationElement {
   ...
   * @see goedegep.travels.model.TravelsPackage#getGPXTrack_TrackReference()
  ...
  /**
   * Sets the value of the '{@link goedegep.travels.model.GPXTrack#getTrackReference <em>Track Reference</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Unsets the value of the '{@link goedegep.travels.model.GPXTrack#getTrackReference <em>Track Reference</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetTrackReference()
   * @see #getTrackReference()
  ...
  /**
   * Returns whether the value of the '{@link goedegep.travels.model.GPXTrack#getTrackReference <em>Track Reference</em>}' containment reference is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->

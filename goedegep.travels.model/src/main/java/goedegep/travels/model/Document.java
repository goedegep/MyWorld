 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.travels.model.Document#getDocumentReference <em>Document Reference</em>}</li>
 * </ul>
 *
 * @see goedegep.travels.model.TravelsPackage#getDocument()
 * @model
 * @generated
 */
public interface Document extends VacationElement {
   ...
   * @see goedegep.travels.model.TravelsPackage#getDocument_DocumentReference()
  ...
  /**
   * Sets the value of the '{@link goedegep.travels.model.Document#getDocumentReference <em>Document Reference</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Unsets the value of the '{@link goedegep.travels.model.Document#getDocumentReference <em>Document Reference</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetDocumentReference()
   * @see #getDocumentReference()
  ...
  /**
   * Returns whether the value of the '{@link goedegep.travels.model.Document#getDocumentReference <em>Document Reference</em>}' containment reference is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->

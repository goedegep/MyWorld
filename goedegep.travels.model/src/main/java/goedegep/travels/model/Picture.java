 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.travels.model.Picture#getPictureReference <em>Picture Reference</em>}</li>
 * </ul>
 *
 * @see goedegep.travels.model.TravelsPackage#getPicture()
 * @model
 * @generated
 */
public interface Picture extends VacationElement {
   ...
   * @see goedegep.travels.model.TravelsPackage#getPicture_PictureReference()
  ...
  /**
   * Sets the value of the '{@link goedegep.travels.model.Picture#getPictureReference <em>Picture Reference</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Unsets the value of the '{@link goedegep.travels.model.Picture#getPictureReference <em>Picture Reference</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetPictureReference()
   * @see #getPictureReference()
  ...
  /**
   * Returns whether the value of the '{@link goedegep.travels.model.Picture#getPictureReference <em>Picture Reference</em>}' containment reference is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->

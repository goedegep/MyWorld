 ...
 * <!-- end-user-doc -->
 * @see goedegep.icons.iconset.model.ModelPackage#getColorType()
 * @model
 * @generated
 */
public enum ColorType implements Enumerator {
   ...
   * @ordered
   */
  BLACK_AND_WHITE(0, "BLACK_AND_WHITE", "BLACK_AND_WHITE"),
   ...
   * @ordered
   */
  public static final int BLACK_AND_WHITE_VALUE = 0;
   ...
   * @ordered
   */
  public static final int GRAY_4_VALUE = 1;
   ...
   * @ordered
   */
  public static final int GRAY_8_VALUE = 2;
   ...
   * @ordered
   */
  public static final int RGB555_VALUE = 3;
   ...
   * @ordered
   */
  public static final int RGB565_VALUE = 4;
   ...
   * @ordered
   */
  public static final int RGB888_VALUE = 5;

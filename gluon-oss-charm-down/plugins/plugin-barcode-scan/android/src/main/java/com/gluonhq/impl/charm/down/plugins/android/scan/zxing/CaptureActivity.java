...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
  ...
  public void onCreate(Bundle icicle) {
    ...
    defaultSharedPreferencesEditor.putBoolean(PreferencesActivity.KEY_DECODE_AZTEC, false);
  ...
  private void handleDecodeExternally(Result rawResult, ResultHandler resultHandler, Bitmap barcode) {
    ...
    if (resultDurationMS > 0) {
      ...
      captureActivityView.getStatusView().setText(resultHandler.getDisplayTitle() + " : " + rawResultString);
    }
  ...
  private void resetStatusView() {
    captureActivityView.getStatusView().setText("Place a barcode inside the viewfinder rectangle to scan it.");

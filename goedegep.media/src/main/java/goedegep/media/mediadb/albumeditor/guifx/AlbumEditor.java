...
import goedegep.media.mediadb.derivealbuminfo.AlbumInfo;
import goedegep.media.mediadb.derivealbuminfo.DeriveAlbumInfo;
import goedegep.media.mediadb.derivealbuminfo.DiscInfo;
...
//    }
  ...
  private Node createImportControlsPanel() {
    ...
    button.setOnAction(_ -> newAlbumBasedOnTrackInFolder(folderSelecter.getAbsolutePath()));
    folderSelecter.addListener((_) -> updateDeriveAlbumDetailsButtonStatus(button, folderSelecter));

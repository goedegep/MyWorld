...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Uncontrolled Root Folder Info</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link goedegep.pctools.filescontrolled.model.impl.UncontrolledRootFolderInfoImpl#getFolderBasePath <em>Folder Base Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UncontrolledRootFolderInfoImpl extends UncontrolledFolderInfoImpl implements UncontrolledRootFolderInfo {
  /**
   ...
   * @generated
   */
  protected UncontrolledRootFolderInfoImpl() {
    super();
  }
  ...
  protected EClass eStaticClass() {
    return PCToolsPackage.Literals.UNCONTROLLED_ROOT_FOLDER_INFO;
  }
  ...
  public void setFolderBasePath(String newFolderBasePath) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PCToolsPackage.UNCONTROLLED_ROOT_FOLDER_INFO__FOLDER_BASE_PATH, oldFolderBasePath, folderBasePath, !oldFolderBasePathESet));
  }
  ...
  public void unsetFolderBasePath() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, PCToolsPackage.UNCONTROLLED_ROOT_FOLDER_INFO__FOLDER_BASE_PATH, oldFolderBasePath, FOLDER_BASE_PATH_EDEFAULT, oldFolderBasePathESet));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case PCToolsPackage.UNCONTROLLED_ROOT_FOLDER_INFO__FOLDER_BASE_PATH:
        return getFolderBasePath();
    }
...
} //UncontrolledRootFolderInfoImpl

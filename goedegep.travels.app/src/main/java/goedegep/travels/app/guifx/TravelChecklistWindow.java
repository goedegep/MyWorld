...
public class TravelChecklistWindow extends JfxStage {
  private static final Logger LOGGER = Logger.getLogger(TravelChecklistWindow.class.getName());
   ...
   */
  public TravelChecklistWindow(CustomizationFx customization, EMFResource<VacationChecklist> vacationChecklistResource) {

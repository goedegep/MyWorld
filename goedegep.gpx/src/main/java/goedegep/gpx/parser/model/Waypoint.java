...
public class Waypoint extends Extension {
    ...
    public void toString(StringBuilder buf, Indent indent, boolean setValuesOnly) {
      if (!setValuesOnly  ||  (latitude != 0.0)  ||  (longitude != 0.0)  ||  (elevation != 0.0)) {
        buf.append(indent.toString()).append("latitude: ").append(latitude);
        buf.append(indent.toString()).append(", longitude: ").append(longitude);
        buf.append(indent.toString()).append(", elevation: ").append(elevation).append(NEWLINE);
      }
      ...
      if (!setValuesOnly  ||  (magneticVariation != null)) {
        buf.append(indent.toString()).append("magneticVariation: ").append(magneticVariation).append(NEWLINE);
      }

      if (!setValuesOnly  ||  (geoIdHeight != null)) {
        buf.append(indent.toString()).append("geoIdHeight: ").append(geoIdHeight).append(NEWLINE);
      }
      ...
      if (!setValuesOnly  ||  (sym != null)) {
        buf.append(indent.toString()).append("sym: ").append(sym).append(NEWLINE);
      }
      ...
      if (!setValuesOnly  ||  (fix != null)) {
        buf.append(indent.toString()).append("fix: ").append(fix).append(NEWLINE);
      }

      if (!setValuesOnly  ||  (sat != 0)) {
        buf.append(indent.toString()).append("sat: ").append(sat).append(NEWLINE);
      }

      if (!setValuesOnly  ||  (hdop != null)) {
        buf.append(indent.toString()).append("hdop: ").append(hdop).append(NEWLINE);
      }

      if (!setValuesOnly  ||  (vdop != null)) {
        buf.append(indent.toString()).append("vdop: ").append(vdop).append(NEWLINE);
      }

      if (!setValuesOnly  ||  (pdop != null)) {
        buf.append(indent.toString()).append("pdop: ").append(pdop).append(NEWLINE);
      }

      if (!setValuesOnly  ||  (ageOfGpsData != null)) {
        buf.append(indent.toString()).append("ageOfGpsData: ").append(ageOfGpsData).append(NEWLINE);
      }

      if (!setValuesOnly  ||  (dGpsStationId != 0)) {
        buf.append(indent.toString()).append("dGpsStationId: ").append(dGpsStationId).append(NEWLINE);      
      }
    }
}

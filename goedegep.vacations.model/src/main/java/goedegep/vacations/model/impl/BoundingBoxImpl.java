 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.vacations.model.impl.BoundingBoxImpl#getWest <em>West</em>}</li>
 *   <li>{@link goedegep.vacations.model.impl.BoundingBoxImpl#getNorth <em>North</em>}</li>
 *   <li>{@link goedegep.vacations.model.impl.BoundingBoxImpl#getEast <em>East</em>}</li>
 *   <li>{@link goedegep.vacations.model.impl.BoundingBoxImpl#getSouth <em>South</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoundingBoxImpl extends MinimalEObjectImpl.Container implements BoundingBox {
  ...
  protected EClass eStaticClass() {
    return VacationsPackage.Literals.BOUNDING_BOX;
  }
  ...
  public void setWest(Double newWest) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VacationsPackage.BOUNDING_BOX__WEST, oldWest, west,
          !oldWestESet));
  }
  ...
  public void unsetWest() {
    ...
    westESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, VacationsPackage.BOUNDING_BOX__WEST, oldWest,
          WEST_EDEFAULT, oldWestESet));
  }
  ...
  public void setNorth(Double newNorth) {
    ...
    northESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VacationsPackage.BOUNDING_BOX__NORTH, oldNorth, north,
          !oldNorthESet));
  }
  ...
  public void unsetNorth() {
    ...
    northESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, VacationsPackage.BOUNDING_BOX__NORTH, oldNorth,
  ...
  public void setEast(Double newEast) {
    ...
    eastESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VacationsPackage.BOUNDING_BOX__EAST, oldEast, east,
          !oldEastESet));
  }
  ...
  public void unsetEast() {
    ...
    eastESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, VacationsPackage.BOUNDING_BOX__EAST, oldEast,
          EAST_EDEFAULT, oldEastESet));
  }
  ...
  public void setSouth(Double newSouth) {
    ...
    southESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VacationsPackage.BOUNDING_BOX__SOUTH, oldSouth, south,
          !oldSouthESet));
  }
  ...
  public void unsetSouth() {
    ...
    southESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, VacationsPackage.BOUNDING_BOX__SOUTH, oldSouth,
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
    case VacationsPackage.BOUNDING_BOX__WEST:
      return getWest();
    case VacationsPackage.BOUNDING_BOX__NORTH:
      return getNorth();
    case VacationsPackage.BOUNDING_BOX__EAST:
      return getEast();
    case VacationsPackage.BOUNDING_BOX__SOUTH:
      return getSouth();
    }
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    switch (operationID) {
    case VacationsPackage.BOUNDING_BOX___IS_VALID:
      return isValid();
    }

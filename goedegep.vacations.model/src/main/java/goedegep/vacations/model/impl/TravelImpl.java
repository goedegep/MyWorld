 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.vacations.model.impl.TravelImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TravelImpl extends EventImpl implements Travel {
  ...
  protected EClass eStaticClass() {
    return VacationsPackage.Literals.TRAVEL;
  }
  ...
  public void setTitle(String newTitle) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VacationsPackage.TRAVEL__TITLE, oldTitle, title,
          !oldTitleESet));
  }
  ...
  public void unsetTitle() {
    ...
    titleESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, VacationsPackage.TRAVEL__TITLE, oldTitle, TITLE_EDEFAULT,
          oldTitleESet));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
    case VacationsPackage.TRAVEL__TITLE:
      return getTitle();
    }
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    switch (operationID) {
    case VacationsPackage.TRAVEL___GET_ID:
      return getId();
    case VacationsPackage.TRAVEL___GET_ALL_FILE_REFERENCES:

 ...
 * </p>
 * <ul>
 *   <li>{@link goedegep.vacations.model.impl.GPXTrackImpl#getTrackReference <em>Track Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GPXTrackImpl extends VacationElementImpl implements GPXTrack {
  ...
  protected EClass eStaticClass() {
    return VacationsPackage.Literals.GPX_TRACK;
  }
  ...
  public NotificationChain basicSetTrackReference(FileReference newTrackReference, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          VacationsPackage.GPX_TRACK__TRACK_REFERENCE, oldTrackReference, newTrackReference, !oldTrackReferenceESet);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newTrackReference != trackReference) {
      ...
      if (trackReference != null)
        msgs = ((InternalEObject) trackReference).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - VacationsPackage.GPX_TRACK__TRACK_REFERENCE, null, msgs);
      ...
      trackReferenceESet = true;
      if (eNotificationRequired())
        eNotify(new ENotificationImpl(this, Notification.SET, VacationsPackage.GPX_TRACK__TRACK_REFERENCE,
  ...
  public NotificationChain basicUnsetTrackReference(NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET,
          VacationsPackage.GPX_TRACK__TRACK_REFERENCE, oldTrackReference, null, oldTrackReferenceESet);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void unsetTrackReference() {
    if (trackReference != null) {
      ...
      trackReferenceESet = false;
      if (eNotificationRequired())
        eNotify(new ENotificationImpl(this, Notification.UNSET, VacationsPackage.GPX_TRACK__TRACK_REFERENCE, null, null,
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
    case VacationsPackage.GPX_TRACK__TRACK_REFERENCE:

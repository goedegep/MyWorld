package goedegep.finan.svc;

import java.io.InputStream;
import java.util.Properties;

import goedegep.configuration.model.Look;
import goedegep.finan.gui.FinanMenuWindow;
import goedegep.finan.gui.FinanResourcesFx;
...
public class FinanService extends Service {
  ...
  protected void readApplicationProperties() {
    ...
    try (InputStream in = getClass().getResourceAsStream("FinanApplication.properties")) {
        ...
        finanRegistry.setVersion(props.getProperty("finan.version"));
        finanRegistry.setApplicationName(props.getProperty("finan.name"));
        finanRegistry.setAuthor(props.getProperty("finan.author"));
        finanRegistry.setCopyrightMessage(props.getProperty("finan.copyright"));
        finanRegistry.setShortProductInfo(props.getProperty("finan.description"));
    } catch (Exception e) {

...
public class LynxTransactionContentHandler
    extends AbstractValidatingHandler<LynxTransactionContentHandler.State>
  ...
  private Lynx       bank = null;           // The bank to which the transactions apply.
  ...
  static {
    accountHandlerClassMap.put(LynxBasic.EFFECTEN_REKENING_STRING, LynxEffRekTransactionContentHandler.class);
  }
  
  public LynxTransactionContentHandler() {
  }

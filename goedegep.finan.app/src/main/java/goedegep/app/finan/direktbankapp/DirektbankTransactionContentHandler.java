...
public class DirektbankTransactionContentHandler
    extends AbstractValidatingHandler<DirektbankTransactionContentHandler.State>
  ...
  private Direktbank   bank = null;       // The bank to which the transactions apply.
  ...
  static {
    accountHandlerClassMap.put(DirektSpRek.getAccountName(), DirektSpRekTransactionContentHandler.class);
  }
  
  public DirektbankTransactionContentHandler() {
  }

  public void setAccount(SumAccount sumAccount, Bank bank) {
    this.sumAccount = sumAccount;
    this.bank = (Direktbank) bank;
...
//    System.out.println("DirektbankTransactionContentHandler: startElement = " + localpart + ", state = " + state);
    data = null;
...
//    System.out.println("DirektbankTransactionContentHandler: endElement = " + localpart);

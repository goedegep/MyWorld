...
/**
 * This class provides a window for fiscal yearly overviews.
 * <p>
 * The window consists of the following parts:
 * <ul>
 * <li>
 * Year selection<br/>
 * To select the year for which the information is shown.
 * </li>
 * </ul>
 */
@SuppressWarnings("serial")
public class EffRekFiscaalJaaroverzichtWindow extends AppFrame {
  ...
  /**
   * Create a fiscal yearly overviews window.
   * 
   * @param customization the GUI customization
   * @param finanBank The bank related to the <b>stockDepot</b>. This is a {@link FinanBank} because that add GUI information to a {@link Bank}.
   * @param stockDepot the stock depot for which the information is shown
   */
  public EffRekFiscaalJaaroverzichtWindow(Customization customization, FinanBank finanBank, StockDepot stockDepot) {
    super(finanBank.getBank().getName() + " " + WINDOW_TITLE, customization, new Dimension(800, 720));

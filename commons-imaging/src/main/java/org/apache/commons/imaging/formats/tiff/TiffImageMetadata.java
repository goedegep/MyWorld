...
public class TiffImageMetadata extends GenericImageMetadata {
     ...
     * Get the Directories.
     * 
     * @return the Directories as a list of <code>ImageMetadataItem</code>
     */
//    public List<? extends ImageMetadataItem> getDirectories() {
    @SuppressWarnings("unchecked")
    public List<Directory> getDirectories() {
        // The Directories are the items of our super type GenericImageMetadata
        return (List<Directory>) super.getItems();

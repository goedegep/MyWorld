...
import goedegep.pctools.gui.PCToolsAppResourcesFx;
import goedegep.pctools.gui.PCToolsMenuWindow;
...
public class PCToolsService extends Service {
  ...
  protected void readApplicationProperties() {
    ...
    try (InputStream in = getClass().getResourceAsStream("PCToolsApplication.properties")) {
        ...
        pcToolsRegistry.setVersion(props.getProperty("pctools.version"));
        pcToolsRegistry.setApplicationName(props.getProperty("pctools.name"));
        pcToolsRegistry.setAuthor(props.getProperty("pctools.author"));
        pcToolsRegistry.setCopyrightMessage(props.getProperty("pctools.copyright"));
        pcToolsRegistry.setShortProductInfo(props.getProperty("pctools.description"));
    } catch (Exception e) {

...
class CountryEditPanel {
  ...
  private void fillFieldsFromCountry(Country country) {
    countryTextField.setText(country != null ? country.getCountryName() : null);
  }
...
class CountriesTableDescriptor extends EObjectTableDescriptor<Country> {
  ...
  private static Map<TableRowOperation, TableRowOperationDescriptor<Country>> rowOperations = new HashMap<>() {
    {

...
class CityEditPanel {
  ...
  private void fillFieldsFromCity(City city) {
    ...
    countryTextField.setText(city.getCountry().getCountryName());
  }
...
class CitiesTableDescriptor extends EObjectTableDescriptor<City> {
  ...
  private static Map<TableRowOperation, TableRowOperationDescriptor<City>> rowOperations = new HashMap<>() {
    {

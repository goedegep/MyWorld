...
public class LocationSearchWindow extends JfxStage {
  ...
  /**
   * An instance of a {@code TravelsWindow}.
   */
   ...
   */
  public LocationSearchWindow(CustomizationFx customization, NominatimAPI nominatimAPI, TravelsWindow vacationsWindow) {
...
class LocationPanel extends VBox {
   ...
   */
  public LocationPanel(CustomizationFx customization, ReverseGeoCodePanel reverseGeoCodePanel, TravelsWindow vacationsWindow, ObjectSelector<OSMLocationInfo> osmLocationInfoSelector) {
  ...
  private void focusMapViewOnLocation() {
    ...
    if (coordinates != null) {
      ...
      WGS84Coordinates mapPoint = new WGS84Coordinates(coordinates.getLatitude(), coordinates.getLongitude());
  ...
  private boolean selectedTreeItemIsLocationsList() {
    return TravelsTreeViewCreator.treeItemIsLocationsList(selectedTreeItem);
  }
  ...
  private boolean selectedTreeItemIsLocationsListItem() {
    ...
    return TravelsTreeViewCreator.treeItemIsLocationsList(parentTreeItem);
  }

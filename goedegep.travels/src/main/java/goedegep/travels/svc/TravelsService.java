...
//    }
  ...
  protected void readApplicationProperties() {
    ...
    try (InputStream in = getClass().getResourceAsStream("TravelsApplication.properties")) {
        ...
        vacationsRegistry.setVersion(props.getProperty("travels.version"));
        vacationsRegistry.setApplicationName(props.getProperty("travels.name"));
        vacationsRegistry.setAuthor(props.getProperty("travels.author"));
        vacationsRegistry.setCopyrightMessage(props.getProperty("travels.copyright"));
        vacationsRegistry.setShortProductInfo(props.getProperty("travels.description"));

...
{
    private static final Logger LOG = Logger.getLogger(FlateFilterDecoderStream.class.getName());
    ...
    private boolean fetch() throws IOException
    {
        ...
        catch (DataFormatException exception)
        {
            ...
            LOG.warning("FlateFilter: premature end of stream due to a DataFormatException = " +

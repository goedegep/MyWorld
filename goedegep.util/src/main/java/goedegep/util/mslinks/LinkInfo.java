...
import goedegep.util.mslinks.data.*;
...
public class LinkInfo implements Serializable {
  private static final String         NEWLINE = System.getProperty("line.separator");
    ...
    public String toString() {
      ...
      buf.append("LinkInfo:").append(NEWLINE);
      
      buf.append(lif.toString());
      buf.append(vid.toString());
      buf.append("  LocalBasePath: ").append(localBasePath).append(NEWLINE);
      if (cnrlink != null) {
        buf.append(cnrlink.toString());
      } else {
        buf.append("  CommonNetworkRelativeLink: <null>").append(NEWLINE);
      }
      buf.append("  CommonPathSuffic: ").append(commonPathSuffix).append(NEWLINE);

...
public class CNRLink implements Serializable {
  private static final String         NEWLINE = System.getProperty("line.separator");
    ...
    public String toString() {
      ...
      buf.append("  CommonNetworkRelativeLink:").append(NEWLINE);
      
      buf.append(flags.toString());
      buf.append("    NetworkProviderType: ").append(nptype).append(NEWLINE);
      buf.append("    NetName: ").append(netname).append(NEWLINE);
      buf.append("    DeviceName: ").append(devname).append(NEWLINE);

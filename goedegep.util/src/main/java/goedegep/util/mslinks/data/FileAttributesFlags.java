...
public class FileAttributesFlags extends BitSet32 {
  ...
  public FileAttributesFlags(int n) {
    ...
    public String toString() {
      ...
      buf.append("  FileAttributes: ").append(NEWLINE);

      buf.append("    isReadonly: ").append(isReadonly()).append(NEWLINE);
      buf.append("    isHidden: ").append(isHidden()).append(NEWLINE);
      buf.append("    isSystem: ").append(isSystem()).append(NEWLINE);
      buf.append("    isDirecory: ").append(isDirecory()).append(NEWLINE);
      buf.append("    isArchive: ").append(isArchive()).append(NEWLINE);
      buf.append("    isNormal: ").append(isNormal()).append(NEWLINE);
      buf.append("    isTemporary: ").append(isTemporary()).append(NEWLINE);
      buf.append("    isSparseFile: ").append(isSparseFile()).append(NEWLINE);
      buf.append("    isReparsePoint: ").append(isReparsePoint()).append(NEWLINE);
      buf.append("    isCompressed: ").append(isCompressed()).append(NEWLINE);
      buf.append("    isOffline: ").append(isOffline()).append(NEWLINE);
      buf.append("    isNotContentIndexed: ").append(isNotContentIndexed()).append(NEWLINE);
      buf.append("    isEncypted: ").append(isEncypted()).append(NEWLINE);

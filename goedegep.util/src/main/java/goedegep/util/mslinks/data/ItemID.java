...
import goedegep.util.mslinks.UnsupportedCLSIDException;
...
//		int pos = bw.getPosition();
    ...
    public String toString() {
      ...
      buf.append("  ItemID:").append(NEWLINE);
      buf.append("    type: ");
      switch(type) {
      case TYPE_UNKNOWN:
        buf.append("Unknown");
      ...
      buf.append(NEWLINE);
      buf.append("    size: ").append(size).append(NEWLINE);
      buf.append("    shortname: ").append(shortname).append(NEWLINE);
      buf.append("    longname: ").append(longname).append(NEWLINE);
      buf.append("    clsid: ");
      if (clsid == null) {
        buf.append("null");
      } else {
        buf.append(clsid.toString());
      }
      buf.append(NEWLINE);
      buf.append("    data: ");
      if (data != null) {

...
public class CNRLinkFlags extends BitSet32 {
  private static final String         NEWLINE = System.getProperty("line.separator");
    ...
    public String toString() {
      ...
      buf.append("    CommonNetworkRelativeLinkFlags:").append(NEWLINE);
      
      buf.append("      isValidDevice: ").append(isValidDevice()).append(NEWLINE);
      buf.append("      isValidNetType: ").append(isValidNetType()).append(NEWLINE);

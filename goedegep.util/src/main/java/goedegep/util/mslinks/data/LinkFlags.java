...
public class LinkFlags extends BitSet32 {
  private static final String         NEWLINE = System.getProperty("line.separator");
    ...
    public String toString() {
      ...
      buf.append("  LinkFlags: ").append(NEWLINE);

      buf.append("    hasLinkTargetIDList: ").append(hasLinkTargetIDList()).append(NEWLINE);
      buf.append("    hasLinkInfo: ").append(hasLinkInfo()).append(NEWLINE);
      buf.append("    hasName: ").append(hasName()).append(NEWLINE);
      buf.append("    hasRelativePath: ").append(hasRelativePath()).append(NEWLINE);
      buf.append("    hasWorkingDir: ").append(hasWorkingDir()).append(NEWLINE);
      buf.append("    hasArguments: ").append(hasArguments()).append(NEWLINE);
      buf.append("    hasIconLocation: ").append(hasIconLocation()).append(NEWLINE);
      buf.append("    isUnicode: ").append(isUnicode()).append(NEWLINE);
      buf.append("    forceNoLinkInfo: ").append(forceNoLinkInfo()).append(NEWLINE);
      buf.append("    hasExpString: ").append(hasExpString()).append(NEWLINE);
      buf.append("    runInSeparateProcess: ").append(runInSeparateProcess()).append(NEWLINE);
      buf.append("    hasDarwinID: ").append(hasDarwinID()).append(NEWLINE);
      buf.append("    runAsUser: ").append(runAsUser()).append(NEWLINE);
      buf.append("    hasExpIcon: ").append(hasExpIcon()).append(NEWLINE);
      buf.append("    noPidlAlias: ").append(noPidlAlias()).append(NEWLINE);
      buf.append("    runWithShimLayer: ").append(runWithShimLayer()).append(NEWLINE);
      buf.append("    forceNoLinkTrack: ").append(forceNoLinkTrack()).append(NEWLINE);
      buf.append("    enableTargetMetadata: ").append(enableTargetMetadata()).append(NEWLINE);
      buf.append("    disableLinkPathTracking: ").append(disableLinkPathTracking()).append(NEWLINE);
      buf.append("    disableKnownFolderTracking: ").append(disableKnownFolderTracking()).append(NEWLINE);
      buf.append("    disableKnownFolderAlias: ").append(disableKnownFolderAlias()).append(NEWLINE);
      buf.append("    allowLinkToLink: ").append(allowLinkToLink()).append(NEWLINE);
      buf.append("    unaliasOnSave: ").append(unaliasOnSave()).append(NEWLINE);
      buf.append("    preferEnvironmentPath: ").append(preferEnvironmentPath()).append(NEWLINE);
      buf.append("    keepLocalIDListForUNCTarget: ").append(keepLocalIDListForUNCTarget()).append(NEWLINE);

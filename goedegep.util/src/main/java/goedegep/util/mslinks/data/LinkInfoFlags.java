...
public class LinkInfoFlags extends BitSet32 {
  private static final String         NEWLINE = System.getProperty("line.separator");
    ...
    public String toString() {
      ...
      buf.append("  LinkInfoFlags:").append(NEWLINE);
      
      buf.append("  hasVolumeIDAndLocalBasePath: ").append(hasVolumeIDAndLocalBasePath()).append(NEWLINE);
      buf.append("  hasCommonNetworkRelativeLinkAndPathSuffix: ").append(hasCommonNetworkRelativeLinkAndPathSuffix()).append(NEWLINE);

...
public class VolumeID implements Serializable {
  private static final String         NEWLINE = System.getProperty("line.separator");
    ...
    public String toString() {
      ...
      buf.append("  VolumeID:").append(NEWLINE);
      
      buf.append("  DriveType: ").append(dt).append(NEWLINE);
      buf.append("  DriveSerialNumber: ").append(dsn).append(NEWLINE);
      buf.append("  Data: ").append(label).append(NEWLINE);

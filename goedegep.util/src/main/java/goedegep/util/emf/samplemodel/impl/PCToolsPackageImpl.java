...
public class PCToolsPackageImpl extends EPackageImpl implements PCToolsPackage {
  ...
  public static PCToolsPackage init() {
    ...
    PCToolsPackageImpl thePCToolsPackage = (PCToolsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PCToolsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new PCToolsPackageImpl());

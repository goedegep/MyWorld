...
public class DoubleClickEventDispatcher implements EventDispatcher {
    ...
    public static final EventType<MouseEvent> MOUSE_DOUBLE_CLICKED = new EventType<>(MouseEvent.ANY, "MOUSE_DBL_CLICKED");
        ...
        if (type == MouseEvent.MOUSE_CLICKED) {
            ...
            if (mouseEvent.getClickCount() > 1) {
                if (clickedTimeline != null) {
                    ...
                    final MouseEvent dblClickedEvent = copy(mouseEvent, MOUSE_DOUBLE_CLICKED);

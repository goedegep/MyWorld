...
public interface TreeItemVisitor<T> {
     ...
     */
    TreeItemVisitResult preVisitChildren(TreeItem<T> treeItem);
     ...
     *          if an I/O error occurs
     */
    TreeItemVisitResult visitTreeItem(TreeItem<T> treeItem);
     ...
     *          if an I/O error occurs
     */
    FileVisitResult postVisitChildren(TreeItem<T> treeItem);
}

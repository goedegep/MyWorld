...
// copied from package com.sun.javafx.binding;
...
public class ExpressionHelperBase {
    ...
    /**
     * Remove garbage collected weak listeners from an array of listeners.
     * 
     * @param size number of actual listeners in <code>listeners</code>
     * @param listeners the listeners to be trimmed.
     * @return the new size.
     */

...
/**
 * This class provides the common functionality for the FileSelecter and FolderSelecter editor controls.
 * <p>
 ...
 * 
 */
public abstract class EditorControlFileOrFolderSelecterAbstract extends EditorControlTemplate<File> {
  @SuppressWarnings("unused")
  private static final Logger LOGGER = Logger.getLogger(EditorControlFileOrFolderSelecterAbstract.class.getName());
  ...
  /**
   * Width of the {@code pathTextField}.
   */
  private int textFieldWidth;
  
  /**
   * a tooltip text for the {@code pathTextField}
   */
  private String textFieldToolTipText;
   ...
   */
  protected EditorControlFileOrFolderSelecterAbstract(
    ...
    this.textFieldToolTipText = textFieldToolTipText;
  ...
  public void createControls() {
    ...
    pathTextField.textProperty().addListener((o) -> {
      handleNewUserInput(pathTextField);
    });

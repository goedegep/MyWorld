...
import goedegep.jfx.stringconverterandchecker.FlexDateStringConverterAndChecker;
...
//  }
  ...
  public static class FlexDateBuilder extends EditorControlTextField.Builder<FlexDate> {
    ...
    public FlexDateBuilder(String id) {
      ...
      setStringConverter(FlexDateStringConverterAndChecker.getDefaultFormatFlexDateStringConverterAndChecker());
    }
    
    @Override
    public FlexDateBuilder setCustomization(CustomizationFx customization) {

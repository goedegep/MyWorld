...
public class CMap
{
    ...
    public int readCode(InputStream in) throws IOException
    {
        ...
        if (LOG.getLevel() == Level.WARNING)
        {
            ...
            LOG.warning("Invalid character code sequence {} in CMap {}" + sb + cmapName);
        }
        ...
        {
            LOG.warning("mark() and reset() not supported, {} bytes have been skipped" +
                    (maxCodeLength - 1));
        }
    ...
    void addCharMapping(byte[] codes, String unicode)
    {
        switch (codes.length)
        {
            ...
            case 4:
                ...
                break;
            default:
                LOG.warning("Mappings with more than 4 bytes (here: {}) aren't supported yet" + codes.length);
                break;
        }

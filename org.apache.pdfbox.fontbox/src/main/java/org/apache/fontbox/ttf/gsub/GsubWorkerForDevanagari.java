...
{
    private static final Logger LOG = Logger.getLogger(GsubWorkerForDevanagari.class.getName());
    ...
    public List<Integer> applyTransforms(List<Integer> originalGlyphIds)
    {
        ...
        for (String feature : FEATURES_IN_ORDER)
        {
            ...
            LOG.info(MessageFormat.format("applying the feature {}", feature));
            ...
            List<Integer> originalGlyphIds)
    {
        ...
        {
            LOG.info(MessageFormat.format("Glyph substitution list for {0} is empty.", rkrfGlyphsForSubstitution.getName()));
        ...
        {
            LOG.info("Cannot find rkrf candidate. The rkrfGlyphIds doesn't contain lists of two elements.");
            return originalGlyphIds;
        }
    ...
    private List<Integer> applyGsubFeature(ScriptFeature scriptFeature, List<Integer> originalGlyphs)
    {
        ...
        {
            LOG.info(MessageFormat.format("getAllGlyphIdsForSubstitution() for {0} is empty", scriptFeature.getName()));

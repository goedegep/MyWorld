...
{
    private static final Logger LOG = Logger.getLogger(GsubWorkerForGujarati.class.getName());
    ...
    private List<Integer> applyGsubFeature(ScriptFeature scriptFeature, List<Integer> originalGlyphs)
    {
        ...
        {
            LOG.info(MessageFormat.format("getAllGlyphIdsForSubstitution() for {} is empty", scriptFeature.getName()));
